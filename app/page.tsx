    ...
    <main className="px-8 md:px-24 py-12">
      <div className="flex w-full items-center">
        ...
        <div className="space-x-10 items-center hidden md:flex">
          <a href="#why" className="font-bold">
            Why use HOOT
          </a>
          <a href="#how" className="font-bold">
            How it works
          </a>
          {isLoggedIn ? (
      ...
      <div className="mt-20 text-center flex flex-col place-content-center">
        ...
        <div className="font-bold text-lg text-gray-600 mt-12 max-w-xl flex self-center">
          Plan and automate your posts to reach your audience at the best times
      ...
      <div className="mt-12 grid grid-cols-1 xl:grid-cols-3 gap-8 text-white">
        <div className="card bg-gradient-to-tr from-[#1C1E34] to-[#21297C]">
          <div className="card-body">
            ...
            <p>
              Automate your Farcaster posts with ease. Set your content to be
              published at the optimal times without lifting a finger
            </p>
          </div>
        </div>
        <div className="card bg-gradient-to-tr from-[#1C1E34] to-[#21297C]">
          <div className="card-body">
            ...
            <p>
              Leverage powerful analytics to fine-tune your posting strategy.
              Understand your audience and maximize engagement with data-driven
              insights.
            </p>
          </div>
        </div>
        <div className="card bg-gradient-to-tr from-[#1C1E34] to-[#21297C]">
          <div className="card-body">
            ...
            <p>
              Ensure your Farcaster presence remains consistent. Schedule posts
              in advance to keep your audience engaged, even when you're
              offline.
            </p>
          </div>
        </div>
      ...
      <div className="mt-20 grid grid-cols-1 xl:grid-cols-2 gap-y-10 xl:gap-y-0 justify-items-center items-center max-w-5xl mx-auto">
        ...
        <div>
          <p className="text-4xl font-bold">Connect Your Farcaster Account</p>
          <p className="max-w-md font-semibold mt-4">
            Plan and automate your posts to reach your audience at the best
      ...
      <div className="mt-24 grid grid-cols-1 xl:grid-cols-2 gap-y-10 xl:gap-y-0 justify-items-center items-center max-w-5xl mx-auto">
        <div className="order-last xl:order-first">
          <p className="text-4xl font-bold">Create and Schedule Your Posts</p>
          <p className="max-w-md font-semibold mt-4">
            Input your text, upload an image or frame URL, and select the date
            and time for your cast. Chrono makes it easy to plan and schedule
      ...
      <div className="mt-24 grid grid-cols-1 xl:grid-cols-2 justify-items-center gap-y-10 xl:gap-y-0 items-center max-w-5xl mx-auto">
        ...
        <div>
          <p className="text-4xl font-bold">Automate and Optimize</p>
          <p className="max-w-md font-semibold mt-4">
            Once your posts are scheduled, Chrono takes care of the rest. Your
            posts will be automatically published at the right time, and you'll
            get analytics to optimize future postings.
          </p>
        </div>
      </div>
    </main>
